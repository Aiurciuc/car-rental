import styles from "./GeneralFeatures.module.scss";

function GeneralFeatures({ bag, fuel, door, person, snowflake, transmission }) {
  return (
    <div className={styles.generalFeatures}>
      {bag && (
